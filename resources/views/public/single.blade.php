                         ...
                         <div class="post-content-body">
                             ...
                             <div class="row mb-5 mt-5">
                                 <div class="col-md-12 mb-4">
                                     <img src="{{asset('miniblog')}}/images/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                                 </div>
                                 <div class="col-md-6 mb-4">
                                     <img src="{{asset('miniblog')}}/images/img_2.jpg" alt="Image placeholder" class="img-fluid rounded">
                                 </div>
                                 <div class="col-md-6 mb-4">
                                     <img src="{{asset('miniblog')}}/images/img_3.jpg" alt="Image placeholder" class="img-fluid rounded">
                                 </div>
                             </div>
                         ...
                         <div class="sidebar-box">
                             ...
                             <div class="post-entry-sidebar">
                                 <ul>
                                     <li>
                                         <a href="#">
                                             <img src="{{asset('miniblog')}}/images/img_1.jpg" alt="Image placeholder" class="mr-4">
                                             <div class="text">
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{asset('miniblog')}}/images/img_2.jpg" alt="Image placeholder" class="mr-4">
                                             <div class="text">
                                                 <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                                 <div class="post-meta">
                                                     <span class="mr-2">March 15, 2018 </span>
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{asset('miniblog')}}/images/img_3.jpg" alt="Image placeholder" class="mr-4">
                                             <div class="text">
                                                 <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                                 <div class="post-meta">
                                                     <span class="mr-2">March 15, 2018 </span>
